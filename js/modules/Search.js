            ...
            this.resultsDiv.html(`
                <div class="row">
                            ...
                            ${results.professors.map(item => `
                                <li class="professor-card__list-item">
                                    <a class="professor-card" href="${item.permalink}">
                                        <img src="${item.image_url}" alt="${item.title}" class="professor-card__image">
                    ...
                    <div class="one-third">
                        ...
                        ${results.campuses.length ? '<ul class="link-list min-list">' : `<p>No campuses matches that search. <a href="${universityData.root_url}/programs">View all campuses</a></p>`}
